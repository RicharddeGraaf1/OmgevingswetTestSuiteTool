...
public class DoorleveringProcessor {
    public static class DoorleveringResult {
        public final byte[] besluitXml;
        public final byte[] opdrachtXml;
        public final Map<String, byte[]> modifiedFiles;

        public DoorleveringResult(byte[] besluitXml, byte[] opdrachtXml, Map<String, byte[]> modifiedFiles) {
    ...
    public static DoorleveringResult createDoorleveringXml(ZipFile sourceZip, boolean isValidation) throws Exception {
